...
class UserTest < ActiveSupport::TestCase
  ...
  def test_auth 
    ...
    #wrong email
    assert_nil    User.authenticate("nonbob@mcbob.com", "test")
    #wrong password
    assert_nil    User.authenticate("bob@mcbob.com", "wrongpass")
    #wrong email and pass
    assert_nil    User.authenticate("nonbob@mcbob.com", "wrongpass")
  end
  ...
  def test_create
    ...
    u = User.new(:password => "newpassword", :password_confirmation => "newpassword", :email => "newbob@mcbob.com" )
    assert_not_nil u.salt
  ...
  def test_send_new_password
    ...
    assert_equal  @bob, User.authenticate("bob@mcbob.com", new_pass)    
  end
  ...
  def test_sha1
    ...
    u.password = u.password_confirmation = "bobs_secure_password"
    assert u.save   
    assert_equal 'b1d27036d59f9499d403f90e0bcf43281adaa844', u.password_hash
  ...
  def test_protected_attributes
    ...
    u = User.new(:id=>999999, :salt=>"I-want-to-set-my-salt", :password => "newpassword", :password_confirmation => "newpassword", :email => "badbob@mcbob.com" )
    assert u.save
    assert_not_equal 999999, u.id
    assert_not_equal "I-want-to-set-my-salt", u.salt

    u.update_attributes(:id=>999999, :salt=>"I-want-to-set-my-salt", :email => "verybadbob@mcbob.com")
    assert u.save
    assert_not_equal 999999, u.id
    assert_not_equal "I-want-to-set-my-salt", u.salt
    assert_equal "verybadbob@mcbob.com", u.email
  end
end
